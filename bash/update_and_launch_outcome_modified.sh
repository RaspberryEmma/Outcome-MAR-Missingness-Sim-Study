...
rm -f -r Outcome-MAR-Missingness-Sim-Study

# clone most recent version
git clone https://github.com/RaspberryEmma/Outcome-MAR-Missingness-Sim-Study

# change wd
cd Outcome-MAR-Missingness-Sim-Study
cd bash
